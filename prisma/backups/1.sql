...
ALTER SEQUENCE public.artists_id_seq OWNED BY public.artist.id;
...
--
-- Name: fascination; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.fascination (
    id integer NOT NULL,
    name character(30) NOT NULL,
...
ALTER TABLE public.fascination OWNER TO postgres;
...
ALTER SEQUENCE public.fascinations_id_seq OWNED BY public.fascination.id;
...
ALTER SEQUENCE public.stories_id_seq OWNED BY public.story.id;
...
ALTER TABLE ONLY public.artist ALTER COLUMN id SET DEFAULT nextval('public.artists_id_seq'::regclass);
...
--
-- Name: fascination id; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fascination ALTER COLUMN id SET DEFAULT nextval('public.fascinations_id_seq'::regclass);
...
ALTER TABLE ONLY public.story ALTER COLUMN id SET DEFAULT nextval('public.stories_id_seq'::regclass);
...
a174efaf-e2f0-42de-9771-50274a5c6036	a942ffbd25507d142ce6e7c54f66e7f51f65e76c7fc7c5d2472686723fb0367b	2022-11-24 21:38:58.139152+00	init		\N	2022-11-24 21:38:58.139152+00	0
bd4a1a10-cae5-487d-addf-24f7f806d5a7	31e982235df391c37bf125f6a60fb21c10508653edfdbaca1ea850787421d960	2022-11-27 13:25:36.008776+00	20221127132535_descriptors	\N	\N	2022-11-27 13:25:35.988831+00	1
\.
...
COPY public.descriptor (id, word, "timestamp", "storyId") FROM stdin;
1	mad                 	2022-11-27 13:40:39.961	3
2	empty               	2022-11-27 14:07:02.015	3
3	unwritten           	2022-11-27 14:58:57.064	1
4	radiant             	2022-11-27 17:04:52.682	2
\.


--
-- Data for Name: fascination; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.fascination (id, name, intensity, color, tstamp) FROM stdin;
...
COPY public.project (id, name, imagename, url, urlname, description) FROM stdin;
...
1	WhisperBlog                   	whisperblog.png               	https://github.com/georgejmx/whisper-blog                                                                                                                                                               	github link                   	My take on what social media should be like
\.
...
COPY public.story (id, name, keyword, tstamp, paragraphs, theme) FROM stdin;
...
SELECT pg_catalog.setval('public.descriptor_id_seq', 4, true);
...
--
-- Name: artist artists_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: artist artists_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: fascination fascinations_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.fascination
    ADD CONSTRAINT fascinations_name_key UNIQUE (name);


--
-- Name: fascination fascinations_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: project projects_imagename_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: project projects_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: story stories_keyword_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: story stories_name_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: story stories_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: descriptor_id_key; Type: INDEX; Schema: public; Owner: postgres
--

CREATE UNIQUE INDEX descriptor_id_key ON public.descriptor USING btree (id);


--
-- Name: descriptor descriptor_storyId_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.descriptor
    ADD CONSTRAINT "descriptor_storyId_fkey" FOREIGN KEY ("storyId") REFERENCES public.story(id) ON UPDATE CASCADE ON DELETE RESTRICT;
